      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST" action="<?php echo base_url('nonpns/dashboard/update_data') ?>" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                          <label>NIK</label>
                          <input type="hidden" name="nip" class="form-control" value="<?php echo $pegawai->nip; ?>" readonly>
