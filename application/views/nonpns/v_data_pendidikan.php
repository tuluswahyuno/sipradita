      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <table class="table table-hover table-striped table-bordered" id="table1">
            ...
            <a class="btn btn-sm btn-danger tombol-hapus" href="<?php echo base_url('nonpns/pendidikan/delete_pendidikan/').$us->id_pendidikan ?>"><i class="fas fa-trash"></i> Hapus</a>
          </td>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" id="tambah-data" class="modal fade">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('nonpns/pendidikan/tambah_pendidikan') ?>" enctype="multipart/form-data">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" id="editmodal<?php echo $us->id_pendidikan; ?>" class="modal fade">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                <form method="POST" action="<?php echo base_url('nonpns/pendidikan/update_pendidikan') ?>" enctype="multipart/form-data">
