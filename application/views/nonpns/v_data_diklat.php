          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" tabindex="-1" role="dialog" id="tambah-data" class="modal fade">
            ...
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('nonpns/Diklat/tambah_diklat') ?>" enctype="multipart/form-data">
                    ...
                    <input type="text" name="durasi_jp" class="form-control" placeholder="Masukkan JP" >
          ...
          <div aria-hidden="true" tabindex="-1" aria-labelledby="myModalLabel" role="dialog" id="editmodal<?php echo $us->id_diklat; ?>" class="modal fade">
            ...
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('nonpns/Diklat/update_diklat') ?>" enctype="multipart/form-data">
