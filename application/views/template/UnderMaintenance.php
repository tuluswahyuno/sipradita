...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="<?php echo base_url() ?>assets/ComingSoon/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="<?php echo base_url() ?>assets/ComingSoon/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="<?php echo base_url() ?>assets/ComingSoon/assets/css/style.css" rel="stylesheet">
...
<body>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <h2>RSUD dr. Soeratno Gemolong</h2>
            <h3>Arsip menjadi lebih mudah, cepat dan aman</h3>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            ...
            <ul>
              <li><i class="bi bi-check"></i> Pengarsipan Dokumen Kepegawaian</li>
              <li><i class="bi bi-check"></i> Pencarian Dokumen Kepegawaian</li>
              <li><i class="bi bi-check"></i> Penjagaan Kenaikan Pangkat dan Kenaikan Gaji Berkala</li>
            </ul>
            <p class="fst-italic">
  ...
  <!-- Vendor JS Files -->
  <script src="<?php echo base_url() ?>assets/ComingSoon/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="<?php echo base_url() ?>assets/ComingSoon/assets/vendor/php-email-form/validate.js"></script>

  <!-- Template Main JS File -->
  <script src="<?php echo base_url() ?>assets/ComingSoon/assets/js/main.js"></script>
