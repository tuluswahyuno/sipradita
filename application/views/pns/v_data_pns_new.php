<title><?= $title; ?></title>
  ...
  <div class="content-wrapper">
	...
	<p class="text-muted text-center"><?php echo $pegawai->nip; ?></p>
	<ul class="list-group list-group-unbordered mb-3">
	<li class="list-group-item">
		<b><?php echo $pegawai->jpegawai; ?></b> <a class="float-right">Status Pegawai</a>
	</li>
	<li class="list-group-item">
		<b><?php echo $pegawai->nama_pangkat; ?></b> <a class="float-right">Pangkat</a>
	</li>
	<li class="list-group-item">
		<b><?php echo $pegawai->nama_jabatan; ?></b> <a class="float-right">Jabatan</a>
	</li>
	<li class="list-group-item">
		<b><?php echo $pegawai->jenis_jabatan; ?></b> <a class="float-right">Jenis Jabatan</a>
	</li>
	<li class="list-group-item">
	...
	<a href="<?php echo base_url('pns/dashboard/update_data') ?>" class="btn btn-danger btn-block"><b>Update Data</b></a>
	</div>
	...
	<h3 class="timeline-header"><a>Kenaikan Pangkat Terakhir anda adalah</a>
		<span class="badge badge-success"><?php echo date('d-M-Y', strtotime($pegawai->kp_terakhir))  ?></span>
	</h3>
	<div class="timeline-body">
		Kenaikan Pangkat Anda yang akan datang pada 
		<span class="badge badge-success"><?php echo date('d-M-Y', strtotime($pegawai->kp_mendatang))  ?></span>
	</div>
	...
	<h3 class="timeline-header"><a>Kenaikan Gaji Berkala Terakhir anda adalah</a>
		<span class="badge badge-warning"><?php echo date('d-M-Y', strtotime($pegawai->kgb_terakhir))  ?></span>
	</h3>
	<div class="timeline-body">
		Kenaikan Gaji Berkala Anda yang akan datang pada 
		<span class="badge badge-warning"><?php echo date('d-M-Y', strtotime($pegawai->kgb_mendatang))  ?></span>
	</div>
	...
	<div class="col-sm-10">
	<input type="text" class="form-control" id="inputName" value="<?php echo $pegawai->pendidikan." ".$pegawai->prodi; ?>">
	</div>
	</div>
	...
	<div class="col-sm-10">
	<input type="text" class="form-control" id="inputName" value="<?php echo $pegawai->tempat_lahir.", "; ?><?php echo date('d-M-Y', strtotime($pegawai->tgl_lahir))  ?>">
	</div>
	</div>
	...
	<div class="col-sm-10">
	<input type="text" class="form-control" id="inputName" value="<?php echo $pegawai->gender; ?>">
	</div>
	</div>
	...
	<div class="col-sm-10">
	<input type="text" class="form-control" id="inputName" value="<?php echo $pegawai->nik; ?>">
	</div>
	</div>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" tabindex="-1" role="dialog" id="update-foto" class="modal fade">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('pns/Dashboard/update_foto') ?>" enctype="multipart/form-data">
