        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Riwayat Pangkat Golongan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <tr>
                ...
                <td style="text-align: center;">
                 ...
                 <td style="text-align: center;">
                  ...
                  <a class="btn btn-sm btn-danger tombol-hapus" href="<?php echo base_url('pns/pangkat/delete_pangkat/').$us->id_pangkat ?>">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" id="tambah-data" class="modal fade">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('pns/pangkat/tambah_pangkat') ?>" enctype="multipart/form-data">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" id="editmodal<?php echo $us->id_pangkat; ?>" class="modal fade">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                <form method="POST" action="<?php echo base_url('pns/pangkat/update_pangkat') ?>" enctype="multipart/form-data">
