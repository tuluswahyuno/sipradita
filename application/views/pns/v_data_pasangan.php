  ...
  <div class="content-wrapper">
    <section class="content-header">
        <div class="col-sm-12">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo base_url('pns/Pasangan') ?>">Pasangan</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('pns/Anak') ?>">Anak</a>
            </li>
              ...
              <tr>
                ...
                <td style="text-align: center;">
                 ...
                 <td style="text-align: center;">
                  ...
                  <a class="btn btn-sm btn-danger tombol-hapus" href="<?php echo base_url('pns/Pasangan/delete_pasangan/').$us->id_pasangan ?>"><i class="fas fa-trash"></i> Hapus</a>
                </td>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" tabindex="-1" role="dialog" id="tambah-data" class="modal fade">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('pns/Pasangan/tambah_pasangan') ?>" enctype="multipart/form-data">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" id="editmodal<?php echo $us->id_pasangan; ?>" class="modal fade">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                <form method="POST" action="<?php echo base_url('pns/Pasangan/update_pasangan') ?>" enctype="multipart/form-data">
