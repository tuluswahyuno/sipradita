    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
              ...
              <tr>
                ...
                <td style="text-align: center;">
                 ...
                 <td style="text-align: center;">
                  ...
                  <a class="btn btn-sm btn-danger tombol-hapus" href="<?php echo base_url('pns/Diklat/delete_diklat/').$us->id_diklat ?>"><i class="fas fa-trash"></i> Hapus</a>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" tabindex="-1" role="dialog" id="tambah-data" class="modal fade">
            ...
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('pns/Diklat/tambah_diklat') ?>" enctype="multipart/form-data">
                    ...
                    <input type="text" name="institusi" class="form-control" placeholder="Masukkan Institusi Penyelenggara" >
                    ...
                    <input type="text" name="durasi_jp" class="form-control" placeholder="Masukkan Angka JP" >
                    ...
                    <input type="date" name="tgl_mulai" class="form-control" placeholder="Masukkan Tanggal Mulai" >
                    ...
                    <input type="date" name="tgl_selesai" class="form-control" placeholder="Masukkan Tanggal Selesai" >
          ...
          <div aria-hidden="true" tabindex="-1" aria-labelledby="myModalLabel" role="dialog" id="editmodal<?php echo $us->id_diklat; ?>" class="modal fade">
            ...
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('pns/Diklat/update_diklat') ?>" enctype="multipart/form-data">
                    ...
                    <input type="text" name="institusi" class="form-control" value="<?php echo $us->institusi; ?>" >
                    ...
                    <input type="text" name="durasi_jp" class="form-control" value="<?php echo $us->durasi_jp; ?>" >
                    ...
                    <input type="date" name="tgl_mulai" class="form-control" value="<?php echo $us->tgl_mulai; ?>" >
                    ...
                    <input type="date" name="tgl_selesai" class="form-control" value="<?php echo $us->tgl_selesai; ?>" >
                    ...
                    <input type="date" name="berlaku_sampai" class="form-control" value="<?php echo $us->berlaku_sampai; ?>">
