  ...
  <div class="content-wrapper">
    <section class="content-header">
          <div class="col-sm-12">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo base_url('admin/Datapegawai/detail_jabatan/').$detail->nip ?>">Jabatan</a>
            </li>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a>Data Riwayat Jabatan <?php echo "<strong>".$detail->nama_lengkap."</strong>" ?></a>
        </div>
        <div class="card-body">
          ...
          <table class="table table-hover table-striped table-bordered" id="table1">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: center;"><?php echo $us->tmt_jabatan ?></td>
                ...
                <td style="text-align: center;">
                 ...
                 <td style="text-align: center;">
                  ...
                  <a class="btn btn-sm btn-danger tombol-hapus" href="<?php echo base_url('pns/Jabatan/delete_jabatan_detail/').$us->id_jabatan ?>">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" id="tambah-data" class="modal fade">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('pns/jabatan/tambah_jabatan_detail') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Jabatan</label>
                        <input type="hidden" name="nip" class="form-control" value="<?php echo $detail->nip; ?>">
                    ...
                    <input type="text" name="kelas_jabatan" class="form-control" placeholder="Angka Kelas Jabatan" required>
                    </div>
                    </div>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" id="editmodal<?php echo $us->id_jabatan; ?>" class="modal fade">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                <form method="POST" action="<?php echo base_url('pns/jabatan/update_jabatan_detail') ?>" enctype="multipart/form-data">
