  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
          <div class="col-sm-12">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo base_url('admin/datapegawai/detail_pasangan/').$detail->nip ?>">Pasangan</a>
            </li>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a>Data Pasangan <?php echo "<strong>".$detail->nama_lengkap."</strong>" ?></a>
        </div>
        <div class="card-body">
               ...
               <td style="text-align: center;"><?php echo $no++; ?></td>
                ...
                <td style="text-align: center;">
                   ...
                   <?php } elseif ($us->akta_nikah != NULL && $us->akta_cerai != NULL) { ?>
                    ...
                    <a class="btn btn-sm btn-danger" href="<?php echo base_url() . 'uploads/pasangan/' . $us->akta_nikah ?>" target="_blank"> Akta Cerai </a>


                  <?php } elseif ($us->akta_nikah != NULL && $us->akta_cerai == NULL) { ?>

                    <a class="btn btn-sm btn-success" href="<?php echo base_url() . 'uploads/pasangan/' . $us->akta_nikah ?>" target="_blank"> Akte Nikah </a>
                 ...
                 <td style="text-align: center;">
                  ...
                  <a class="btn btn-sm btn-danger tombol-hapus" href="<?php echo base_url('pns/Pasangan/delete_pasangan_detail/').$us->id_pasangan ?>"><i class="fas fa-trash"></i> Hapus</a>
                </td>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" tabindex="-1" role="dialog" id="tambah-data" class="modal fade">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('pns/Pasangan/tambah_pasangan_detail') ?>" enctype="multipart/form-data">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" id="editmodal<?php echo $us->id_pasangan; ?>" class="modal fade">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                <form method="POST" action="<?php echo base_url('pns/Pasangan/update_pasangan_detail') ?>" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="nip" value="<?php echo $detail->nip; ?>" >
                    <input type="hidden" name="id_pasangan" class="form-control" value="<?php echo $us->id_pasangan; ?>">
                   ...
                   <?php } else { ?>
                     ...
                     <a class="btn btn-sm btn-success" href="<?php echo base_url() . 'uploads/pasangan/' . $us->akta_nikah ?>" target="_blank"> Lihat <i class="fas fa-eye"> </a></i>
                   ...
                   <?php } else { ?>
                     ...
                     <a class="btn btn-sm btn-success" href="<?php echo base_url() . 'uploads/pasangan/' . $us->akta_cerai ?>" target="_blank"> Lihat <i class="fas fa-eye"> </a></i>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" id="detailmodal<?php echo $us->id_pasangan; ?>" class="modal fade">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Detail Pasangan</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
