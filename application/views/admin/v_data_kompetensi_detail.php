<title><?= $title; ?></title>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-12">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo base_url('admin/Datapegawai/detail_diklat/').$detail->nip ?>">Diklat</a>
            </li>

            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo base_url('admin/Datapegawai/detail_sipstr/').$detail->nip ?>">SIP/STR</a>
            </li>
              ...
              <tr>
                ...
                <td style="text-align: center;">
                 ...
                 <td style="text-align: center;">
                  ...
                  <a class="btn btn-sm btn-danger tombol-hapus" href="<?php echo base_url('pns/Kompetensi/delete_data_detail/').$us->id_kompetensi ?>"><i class="fas fa-trash"></i> Hapus</a>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" tabindex="-1" role="dialog" id="tambah-data" class="modal fade">
            ...
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('pns/Kompetensi/tambah_kompetensi_detail') ?>" enctype="multipart/form-data">
          ...
          <div aria-hidden="true" tabindex="-1" aria-labelledby="myModalLabel" role="dialog" id="editmodal<?php echo $us->id_kompetensi; ?>" class="modal fade">
            ...
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('pns/Kompetensi/update_data_detail') ?>" enctype="multipart/form-data">
