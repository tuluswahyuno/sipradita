              ...
              <tr>
                ...
                <td style="text-align: center;">
                 ...
                 <td style="text-align: center;">
                  ...
                  <a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editmodal<?php echo $us->id_bankdata; ?>">
                  <i class="fas fa-edit"> </i> Edit</a>
                  </a>
            
                  <a class="btn btn-sm btn-danger tombol-hapus" href="<?php echo base_url('admin/Bankdata/delete_data/').$us->id_bankdata ?>"><i class="fas fa-trash"></i> Hapus</a>
                </td>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('admin/Bankdata/tambah_data') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                    <label>File</label>
                    <input type="file" name="file" class="form-control" accept=".pdf, .xls, .xlsx, .doc, .docx, .jpg, .jpeg, .png" required>
                    <div class="mt-1">
                        <span class="text-secondary">File yang diupload harus dalam format : .pdf, .xls, .xlsx, .doc, .docx, .jpg, .jpeg, .png</span>
                     </div>
                    </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('admin/Bankdata/update_data') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                    <label>File</label>
                    <input type="file" name="file" class="form-control" accept=".pdf, .xls, .xlsx, .doc, .docx, .jpg, .jpeg, .png">
                    <div class="mt-1">
                        <span class="text-secondary">File yang diupload harus dalam format : .pdf, .xls, .xlsx, .doc, .docx, .jpg, .jpeg, .png</span>
                     </div>
                   ...
                   <?php } else { ?>
                     ...
                     <a class="btn btn-primary" href="<?php echo base_url() . 'uploads/bankdata/' . $us->file ?>" target="_blank"> Lihat File</a>
