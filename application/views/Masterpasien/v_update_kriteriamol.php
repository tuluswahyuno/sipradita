    ...
    <div class="card">
      ...
      <div class="card card-success">
        <div class="card-header">
          <h3 class="card-title">Kriteria Moskuloskeletal</h3>
        </div>

        <div class="card-body">

          <form method="POST" action="<?php echo base_url('Ass/MasterPasien/update_kriteriamol_aksi') ?>" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="custom-control custom-checkbox">
                    <input type="hidden" name="id_kriteriamos" value="<?php echo $detail->id_kriteriamos; ?>" class="form-control">
