        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">1. Pernafasan</h3>
              ...
              <div class="card-body">
                ...
                <textarea class="form-control" rows="2"><?php echo $hasil->diagnosa_penafasan ?></textarea>
          ...
          <div class="col-md-6">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">2. Moskuloskelental</h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                    <i class="fas fa-minus"></i>
                  </button>
