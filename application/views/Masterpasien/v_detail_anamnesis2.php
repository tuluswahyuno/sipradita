...
<div class="content-wrapper">
  ...
  <section class="content-header">
          <div class="col-sm-12">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo base_url('Ass/MasterPasien/detail_pasien/').$detail->id_anamnesis ?>">Anamesis</a>
            </li>
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <section class="content">
          ...
          <div class="col-md-6">
            <div class="card card-success">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#collapse4" aria-expanded="false" aria-controls="collapseExample">
                    Lihat Data
                  </button>
                </div>
              </div>
          ...
          <div class="col-md-6">
            <div class="card card-success">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapseExample">
                    Lihat Data
                  </button>
                </div>
              </div>
          ...
          <div class="col-md-6">
            <div class="card card-success">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapseExample">
                    Lihat Data
                  </button>
                </div>
              </div>
          ...
          <div class="col-md-6">
            <div class="card card-success">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#collapse1" aria-expanded="false" aria-controls="collapseExample">
                    Lihat Data
                  </button>
                </div>
              </div>
        ...
        <div align="center">
              <button class="btn btn-success mb-2 ml-2" onclick="history.back()">Kembali</button>
            </div>
