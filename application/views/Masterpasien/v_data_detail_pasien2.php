<title><?= $title; ?></title>
  ...
  <li class="nav-item"><a class="nav-link active" href="#profile" data-toggle="tab">Data Pasien</a></li>
  <li class="nav-item"><a class="nav-link" href="#anamnesis" data-toggle="tab">Anamnesis</a></li>
  ...
  <div class="tab-pane" id="anamnesis">
   ...
   <i class="fas fa-plus-square"> </i> Input Data Anamnesis </a>
   </button>

   <div align="left">
     <a>Riwayat Anamnesis <?php echo "<strong>".$detail->nama."</strong>" ?></a>
   </div>
  ...
  <form class="form-horizontal">
        ...
        <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#tambah-data">
            <i class="fas fa-plus-square"> </i> Input Data Anamnesis </a>
          </button>
