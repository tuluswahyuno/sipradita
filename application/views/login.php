...
<div class="flash-data" data-flasherorr="<?php echo $this->session->flashdata('flash'); ?>"></div>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="#" class="h1"><b> SI PRADITA</b></a><br>
      <a>(Sistem Dokumentasi Keperawatan Digital)</a>
    </div>
    <div class="card-body">
