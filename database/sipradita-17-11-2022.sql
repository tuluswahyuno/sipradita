...
INSERT INTO `data_anamnesis` (`id_anamnesis`, `id_pasien`, `tgl_mrs`, `tgl_pengkajian`, `keluhan_utama`, `riw_penyakit_sekarang`, `pernah_rawat`, `pernah_rawat_diagnosa`, `pernah_rawat_kapan`, `pernah_rawat_di`, `pernah_operasi`, `pernah_operasi_jenis`, `pernah_operasi_kapan`, `pernah_operasi_di`, `obatygdikonsumsi`, `obatygdikonsumsi_jenis`, `riwayat_penyakit_keluarga`, `riwayat_penyakit_jenis`, `penyakit_jenis_lainnya`, `riwayat_alergi`, `alergi_makanan`, `alergi_obat`, `alergi_lainnya`, `agama`, `pendidikan`, `kewarganegaraan`, `pekerjaan`, `status_pernikahan`, `tinggal_bersama_keluarga`, `create_at`, `update_at`) VALUES
	(3, 1, '2022-10-25 10:03:29', '2022-10-25 10:03:29', 'Mual Muntah sudah 3 hari 3 malam tidak tidur', 'Mual Muntah sudah 3 hari 3 malam tidak tidur', 'Pernah', 'asdf', '2022-10-25', 'asdf', 'Pernah', 'asdf', '2022-10-25', 'asdf', 'Ya', 'asdf', 'Ya', 'Tidak Dalam Pilihan', 'asdf', 'Ya', 'asdf', 'asdf', NULL, 'Islam', 'SD', 'WNI', 'PNS', 'Belum Menikah', 'Ya', '2022-10-25 03:03:29', NULL),
	(4, 1, '2022-11-06 16:42:25', '2022-11-06 16:42:25', 'Mual Muntah sudah 3 hari 3 malam tidak tidur', 'Mual Muntah sudah 3 hari 3 malam tidak tidur', 'Pernah', 'asdf', '2022-11-24', 'asd', 'Pernah', '', '2022-11-06', 'asd', 'Ya', 'asdf', 'Ya', 'Tidak Dalam Pilihan', 'asdf', 'Ya', 'asdf', 'asdf', 'asdf', 'Islam', 'SD', 'WNI', 'PNS', 'Belum Menikah', 'Ya', '2022-11-06 09:42:25', NULL),
	(5, 1, '2022-11-08 20:56:31', '2022-11-08 20:56:31', 'Mual Muntah sudah 3 hari 3 malam tidak tidur', 'Mual Muntah sudah 3 hari 3 malam tidak tidur', 'Pernah', 'asdf', '2022-11-23', 'asdf', 'Pernah', 'asdf', '2022-11-06', 'asdf', 'Ya', 'asdf', 'Ya', 'Tidak Dalam Pilihan', 'asdf', 'Ya', 'asdf', 'asdf', 'asdf', 'Islam', 'SD', 'WNI', 'PNS', 'Belum Menikah', 'Ya', '2022-11-08 13:56:31', NULL),
	(7, 1, '2022-11-14 13:22:32', '2022-11-14 13:22:32', 'pusing', 'demam', 'Pernah', 'ewfwqef', '2022-11-14', 'asdf', 'Pernah', 'asdf', '2022-11-14', 'asdf', 'Ya', 'asdf', 'Ya', 'Tidak Dalam Pilihan', 'asdf', 'Ya', 'jengkol', 'asdf', 'asdf', 'Islam', 'Sarjana', 'WNI', 'PNS', 'Belum Menikah', 'Ya', '2022-11-14 06:22:32', NULL),
	(8, 4, '2022-11-14 13:57:32', '2022-11-14 13:57:32', 'nyeri perut', '1minggu mengalami sakit perut bagian bawah', 'Tidak Pernah', '', '0000-00-00', '', 'Tidak Pernah', '', '0000-00-00', '', 'Tidak', '', 'Tidak', 'Tidak Dalam Pilihan', '', 'Tidak', 'asdf', '', '', 'Islam', 'SD', 'WNI', 'PNS', 'Belum Menikah', 'Ya', '2022-11-14 06:57:32', NULL),
	(9, 4, '2022-11-14 14:23:27', '2022-11-14 14:23:27', 'asdf', 'asdfas', 'Pernah', 'asdf', '2022-11-14', 'asdf', 'Pernah', 'asdf', '2022-11-14', 'asdf', 'Ya', 'asdf', 'Ya', 'Tidak Dalam Pilihan', 'asdf', 'Ya', 'asdf', 'asdf', 'asdf', 'Islam', 'SD', 'WNI', 'PNS', 'Belum Menikah', 'Ya', '2022-11-14 07:23:27', NULL);
...
INSERT INTO `data_pasien` (`id_pasien`, `no_rm`, `nama`, `gender`, `t_lahir`, `tgl_lahir`, `nik`, `no_bpjs`, `no_hp`, `agama`, `pekerjaan`, `alamat`, `create_at`, `update_at`, `grafik`) VALUES
	(1, '22070001', 'Tulus Wahyuno', 'Laki-laki', 'Sragen', '1996-07-05', '33140219600078', '9998888667735', '089168467891', 'Islam', 'PNS Daerah', 'Margo Asri, Puro, Karangmalang, Sragen', '2022-07-05 03:56:48', NULL, '1'),
	(4, '22110002', 'EKA MUTYA', 'Perempuan', 'TANGERANG', '2022-11-14', NULL, NULL, '089673393833', 'Islam', 'Swasta', 'margo asri rt 36 rw 08\r\npuro, karangmalang', '2022-11-14 06:56:31', NULL, '1');
...
INSERT INTO `data_pemeriksaan` (`id_pemeriksaan`, `id_anamnesis`, `e`, `v`, `m`, `bb`, `tb`, `kesadaran`, `td`, `rr`, `n`, `s`, `spo`, `keadaan_umum`, `ivline_terpasangdi`, `lokasi`, `tanggal`, `kateter_terpasang_tgl`, `ngtogt_terpasang_tgl`, `create_at`, `update_at`) VALUES
	(1, 3, '1', '2', '2', '2', '2', 'Compos Mentis (GCS 14-15)', '2', '2', '2', '2', '2', 'Baik', 'Lengan', 'Kanan', '2022-10-25', '2022-10-27', '2022-11-04', '2022-10-31 05:59:55', NULL),
	(3, 7, '41', '5', '6', '60', '180', 'Apatis (GCS 12-13)', 'dsaf', 'asd', 'asdf', 'asdf', 'asdf', 'Baik', 'tangan', 'Kiri', '2022-11-14', '2022-11-14', '2022-11-14', '2022-11-14 06:24:15', NULL),
	(4, 8, '4', '5', '6', '70', '158', 'Compos Mentis (GCS 14-15)', '120/80', '20', '80', '36,3', '99', 'Baik', 'tangan', 'Kanan', '2022-11-14', '2022-11-14', '2022-11-14', '2022-11-14 07:02:18', NULL);
...
INSERT INTO `data_periksa` (`id_periksa`, `id_pasien`, `keluhan`, `bb`, `tb`, `status_gizi`, `anamnesis`, `hasil_periksa`, `diagnosis`, `obat`, `status`, `tgl_kunjungan`, `create_at`, `update_at`) VALUES
	(7, 1, 'panas sudah 3 hari tidak mau makan, panas sudah 3 hari tidak mau makan sekali', '9.8', '110', 'Gizi Baik Banget', 'tensi 130/110, denyut nadi normal, tidak panas, tidak ngantuk', 'tidak ada masalah berarti', 'lapar', 'mixagrib 1x2, mixagrib 1x2, mixagrib 1x2, mixagrib 1x2', 1, '2022-07-12 13:52:13', '2022-07-12 06:52:13', '2022-07-13 08:45:54');
...
INSERT INTO `data_user` (`id_user`, `nama_lengkap`, `status_aktif`, `username`, `password`, `role`, `create_at`, `update_at`) VALUES
	(406, 'Tulus Wahyuno', '1', 'tulusw', '8ea2cc6d7d5a961971c7fa974540b37e', '1', '2022-08-29 07:12:13', '2022-08-29 14:12:13'),
	(408, 'Administrator', '1', 'aridwi', '11b2807b6b8b375e2b7f0ef9cc922ecd', '1', '2022-07-22 05:46:54', '2022-07-22 12:46:54');
...
-- Dumping data for table sipradita.grafik: ~4 rows (approximately)
/*!40000 ALTER TABLE `grafik` DISABLE KEYS */;
INSERT INTO `grafik` (`id_grafik`, `id_anamnesis`, `nadi`, `suhu`, `create_at`, `update_at`) VALUES
	(1, '3', '88', '36', '2022-11-13 10:09:07', NULL),
	(2, '3', '90', '37', '2022-11-13 10:09:19', NULL),
	(3, '3', '89', '39', '2022-11-13 10:09:23', NULL),
	(4, '3', '100', '40', '2022-11-13 10:09:48', NULL);
...
-- Dumping data for table sipradita.intervensi_pernafasan: ~1 rows (approximately)
...
INSERT INTO `master_pasien` (`id_pasien`, `no_rm`, `nama`, `tgl_lahir`, `alamat`, `ruang`, `create_at`, `update_at`) VALUES
	(1, '22070001', 'Tulus Wahyuno', '1996-07-05', 'Margo Asri, Puro, Karangmalang, Sragen', 'Anggrek', '2022-07-05 03:56:48', NULL);
...
INSERT INTO `pengkajian_nyeri` (`id_nyeri`, `id_anamnesis`, `nyeri`, `deskripsi`, `lainnya`, `quality`, `region`, `menyebar`, `skala`, `hasil`, `waktu`, `diagnosa_nyeri`, `create_at`, `update_at`) VALUES
	(1, 3, 'Ada', 'Benturan', '-', 'Seperti tertusuk-tusuk benda tajam/tumpul', 'perut', 'Tidak', 'Sedikit Sakit', '4', '< 6 Bulan', 'Nyeri Akut ', '2022-11-08 06:16:16', NULL),
	(3, 8, 'Ada', 'Proses Penyakit', '-', 'Seperti tertusuk-tusuk benda tajam/tumpul', 'perut', 'Ya', '8', '-', '< 6 Bulan', 'Nyeri Akut ', '2022-11-14 07:16:28', NULL),
	(4, 3, 'Ya', 'Benturan', '-', 'Seperti tertusuk-tusuk benda tajam/tumpul', 'tangan', 'Tidak', 'Sedikit Sakit', '4', '< 6 Bulan', 'Nyeri Akut ', '2022-11-16 06:50:12', NULL),
	(5, 3, 'Tidak', 'Benturan', '-', 'Seperti tertusuk-tusuk benda tajam/tumpul', 'perut', 'Tidak', 'Sedikit Sakit', '4', '< 6 Bulan', 'Nyeri Akut ', '2022-11-16 06:50:42', NULL);
...
INSERT INTO `sistem_moskuloskelental` (`id_moskuloskelental`, `id_anamnesis`, `pergerakan_sendi`, `mudah_lelah`, `kekuatan_otot`, `hasil`, `fraktur`, `fraktur_lokasi`, `postur_tubuh`, `skore_resiko_jatuh`, `aktivitas_seharihari`, `berjalan`, `alat_ambulasi`, `kebiasaan_tidur`, `jam_tidur_sebelumsakit`, `jam_tidur_sesudahsakit`, `diagnosa_moskuloskelental`, `create_at`, `update_at`) VALUES
	(4, 3, 'Terbatas', 'Ya', '1', 'asdf', 'Ada', 'asdf', 'Normal', 'asdf', 'Ketergantungan Total', 'Kelumpuhan', 'Walker', 'Tidak', 160800, 181000, 'Gangguan Mobilitas Fisik', '2022-11-01 05:04:10', NULL),
	(7, 7, 'Terbatas', 'Ya', '3', 'sadfas', 'Ada', 'asdfasf', 'Normal', 'afsdf', 'Ketergantungan Total', 'Kelumpuhan', 'Walker', 'Tidak', 2, 3, 'Gangguan Mobilitas Fisik', '2022-11-14 06:27:00', NULL),
	(8, 8, 'Bebas', 'Tidak', '5', 'tidak ada kelainan', 'Tidak', '0', 'Normal', '30', 'Mandiri', 'Tidak ada kesulitan', 'Normal', 'Tidak', 90000, 80000, 'Tidak Terdiagnosa Moskuloskelental', '2022-11-14 07:13:27', NULL);
...
-- Dumping data for table sipradita.sistem_pernafasan: ~3 rows (approximately)
...
INSERT INTO `sistem_pernafasan` (`id_sistempernafasan`, `id_anamnesis`, `pola_nafas`, `irama_nafas`, `retraksi`, `jenis_retraksi`, `jenis_pernafasan`, `alat_bantu`, `alat_bantu_lainnya`, `tekanan`, `terpasang_wsd`, `produksi`, `kesulitan_bernafas`, `kesulitan_bernafas_ya`, `lain_lain`, `saat`, `batukdansekresi`, `batukdansekresi_ya`, `warna_sputum`, `suara_nafas`, `perkusi`, `agd`, `diagnosa_penafasan`, `create_at`, `update_at`) VALUES
	(4, 3, 'Tachipneu', 'Tidak Teratur', 'Ya', 'a', 'Dada', 'NK', 'a', 'a', 'Ya', 'a', 'Ya', 'Dispneu', 'a', 'a', 'Ya', 'Produktif', 'Putih', 'Whizing', 'Sonor', 'PH 7,35-7,45', 'Pola Nafas Tidak Efektif', '2022-10-31 10:14:34', NULL),
	(6, 7, 'Bradikardi', 'Teratur', 'Ya', 'dada', 'Dada', 'NK', 'asdf', 'asdf', 'Ya', 'asdf', 'Ya', 'Dispneu', 'asdfa', 'asdf', 'Ya', 'Produktif', 'Putih', 'Vasikuler', 'Redup', 'HCO3>26', 'Tidak Terdiagnosa', '2022-11-14 06:25:26', NULL),
	(7, 7, 'Tachipneu', 'Teratur', 'Ya', 'dada', 'Dada', 'NK', 'asdf', 'asdf', 'Ya', 'asdf', 'Ya', 'Dispneu', 'asdfa', 'asdf', 'Ya', 'Produktif', 'Putih', 'Vasikuler', 'Redup', 'PH<7,35', 'asdfasd', '2022-11-14 07:06:35', NULL);
...
INSERT INTO `sistem_proteksi` (`id_proteksi`, `id_anamnesis`, `suhu`, `terdapat_luka`, `lokasi_luka`, `kondisi_luka`, `kebersihan_luka`, `riwayat_alergi`, `nama_alergi`, `nilai_leokosit`, `gds`, `diagnosa_proteksi`, `create_at`, `update_at`) VALUES
	(1, 3, '<36,5', 'Ya', 'baik baik saja', 'baik baik saja', 'Tidak', 'Ada', 'baik baik saja', '10000', 'baik baik saja', 'Tidak Terdiagnosa Masalah Proteksi dan Perlindungan', '2022-11-03 07:56:35', NULL),
	(5, 8, '>37,5', 'Tidak', '-', '-', 'Bersih', 'Ada', '-', '120000', '107', 'Hipertermia', '2022-11-14 07:14:51', NULL),
	(6, 3, '<36,5', 'Ya', 'asdf', 'asdf', 'Tidak', 'Ada', 'asdf', '10000', 'asdf', NULL, '2022-11-16 06:18:07', NULL);
